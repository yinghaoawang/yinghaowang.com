      ...
      <div className='inner-wrapper'>
        ...
        <section>
          ...
          <details>
            ...
            <li>
              Developed a social journaling app that allows users to write,
              edit, and manage journal entries, offering profile editing and
          ...
          <details>
            ...
            <li>
              Created a software as a service (SaaS) allowing users to request
              and receive text, images, videos, music, and code in response to
              their prompts.
            </li>
            <li>
              Introduced a token-based payment system, allowing users to
              purchase and use tokens to pay for requests.
            </li>
            <li>
          ...
          <details>
            ...
            <li>
              Utilizes Netlify serverless functions, Firebase authentication,
              and Firestore.
            </li>
          ...
          <details>
            ...
            <li>
              Server also built minimally using Node.js with Express and
              Postgres.
            </li>
            <li>
              Uploaded images are compressed on server then stored in
              Cloudinary.
            </li>
          </details>
        </section>
        <section>
          ...
          <details>
            ...
            <li>
              Appendix of all League of Legends champions and their
              corresponding skins and lore.
            </li>
        ...
        <section hidden>
          ...
          <details>
            ...
            <li>
              Users can search for other users, view their profiles, follow
              them, and send direct messages to them.
            </li>
            <li>
            ...
            <li>
              On the outside, this website seems less impressive than my
              previous one, but this project&apos;s focus is on following best
              practices, security, and structure over speed of development.
            </li>
            <li>
            ...
            <li>
              Much more secure than previous projects because server
              authenticates and handles all the business logic.
            </li>
            <li>
